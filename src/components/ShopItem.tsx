...
import { ShopProps, ProductError, ProductResp } from '../types';
import { days, month, numberWithCommas } from '../utils';

const ShopItem: NextPage<ShopProps> = ({ productResp }) => (
  <div className="w-full pr-4">
    {(productResp as ProductError).status === undefined ? (
      ...
      <div className="bg-white w-full mb-4 py-10 rounded-md flex p-8 pl-16 text-5xl items-center justify-center font-bold text-red-600">No Products Found</div>
    )}
